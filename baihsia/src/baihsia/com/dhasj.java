package baihsia.com; // Giữ nguyên tên package của bạn

import java.util.Scanner; // Lệnh import PHẢI nằm ở trên cùng, ngoài class

public class dhasj { // Tên class phải khớp với tên file dhasj.java
